...
class AppTheme {
  ...
  static ThemeData get dark => ThemeData(
        ...
        appBarTheme: AppBarTheme(
          ...
          elevation: 0,
          titleTextStyle:
              AppTextStyles.headline.copyWith(color: AppColors.textDark),
        ...
        textTheme: TextTheme(
          headlineSmall:
              AppTextStyles.headline.copyWith(color: AppColors.textDark),
          titleMedium:
              AppTextStyles.title.copyWith(color: AppColors.textDark),
          bodyMedium:
              AppTextStyles.body.copyWith(color: AppColors.textDark),
          labelLarge:
              AppTextStyles.label.copyWith(color: AppColors.textDark),
          bodySmall:                                  
              AppTextStyles.body.copyWith(color: AppColors.textDark, fontSize: 14),
        ),
  ...
  static ThemeData get light => ThemeData(
        ...
        appBarTheme: AppBarTheme(
          ...
          elevation: 0,
          titleTextStyle:
              AppTextStyles.headline.copyWith(color: AppColors.textLight),
          shape: const RoundedRectangleBorder(
            borderRadius: BorderRadius.vertical(bottom: Radius.circular(20)),
          ),
        ),
        ...
        textTheme: TextTheme(
          headlineSmall:
              AppTextStyles.headline.copyWith(color: AppColors.textLight),
          titleMedium:
              AppTextStyles.title.copyWith(color: AppColors.textLight),
          bodyMedium:
              AppTextStyles.body.copyWith(color: AppColors.textLight),
          labelLarge:
              AppTextStyles.label.copyWith(color: AppColors.textLight),
          bodySmall:
              AppTextStyles.body.copyWith(color: AppColors.textLight, fontSize: 14),
        ),
        bottomSheetTheme: const BottomSheetThemeData(
